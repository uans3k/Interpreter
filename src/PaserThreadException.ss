...
(define the-grammar
    '((Program (Expression) Program_Default)
      ...
      (Expression ("try" Expression "catch" number Expression) Expression_TryCatch)
      (Expression ("raise" number) Expression_Raise)
      (Expression ("thread" "(" Expression ")" ) Expression_Thread)
      (Expression ("semaphore" "(" Expression ")") Expression_Semaphore)
      (Expression ("p" "(" Expression ")") Expression_P)
      (Expression ("v" "(" Expression ")") Expression_V)
